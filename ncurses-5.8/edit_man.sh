...
*.[0-9]*)
	...
	if test ! -f /home/abinav/cursor movement/ncurses-5.8/man_alias.sed ; then
cat >>/home/abinav/cursor movement/ncurses-5.8/man_alias.sed <<-CF_EOF2
		s,@DATADIR@,$datadir,g
...
s,@TSET@,tset,g
CF_EOF2
		echo "...made /home/abinav/cursor movement/ncurses-5.8/man_alias.sed"
	fi
	...
	aliases=`sed -f $top_srcdir/man/manlinks.sed $inalias |sed -f /home/abinav/cursor movement/ncurses-5.8/man_alias.sed | sort -u`
	cf_target=`grep "^$cf_source" /home/abinav/cursor movement/ncurses-5.8/man/man_db.renames | mawk '{print $2}'`
	...
	sed	-f /home/abinav/cursor movement/ncurses-5.8/man_alias.sed \
		< $i >$TMP
